...
function Create({ auth, categories }) {
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold leading-tight text-gray-800", children: "Nouveau produit" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Nouveau produit" }),
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-3xl sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg p-6", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", encType: "multipart/form-data", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "image", value: "Image" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "image",
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: "Laissez vide pour utiliser votre position enregistrée. Vous pouvez aussi cliquer pour géolocaliser automatiquement." }),
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsx(PrimaryButton, { disabled: processing, className: "bg-green-600 hover:bg-green-700", children: "Enregistrer" }) })
        ] }) }) }) })
      ]
    }
  );
