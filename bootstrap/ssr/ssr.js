...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.jsx`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-DmEx1ueL.js"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-GIoCusLt.js"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-CcwiJ-5J.js"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-D_g5vQWh.js"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-ifPBsFsw.js"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-DBP2NNZM.js"), "./Pages/Dashboard.jsx": () => import("./assets/Dashboard-B3H2G_vy.js"), "./Pages/Farmers/Show.jsx": () => import("./assets/Show-DKDTx_gX.js"), "./Pages/Marketplace/Index.jsx": () => import("./assets/Index-DudjUY6c.js"), "./Pages/Orders/Index.jsx": () => import("./assets/Index-B3TbqCyq.js"), "./Pages/Products/Create.jsx": () => import("./assets/Create-CIkdDIcx.js"), "./Pages/Products/Edit.jsx": () => import("./assets/Edit-BbXLMiks.js"), "./Pages/Products/Index.jsx": () => import("./assets/Index-DtRbufvQ.js"), "./Pages/Products/Show.jsx": () => import("./assets/Show-CqPsBiZg.js"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-DTHpHOhu.js"), "./Pages/Profile/Partials/DeleteUserForm.jsx": () => import("./assets/DeleteUserForm-BNkdKUPG.js"), "./Pages/Profile/Partials/UpdatePasswordForm.jsx": () => import("./assets/UpdatePasswordForm-BBKroAjk.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": () => import("./assets/UpdateProfileInformationForm-fWYqUJjg.js"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-BWkSrG2I.js") })
    ),
    setup: ({ App, props }) => {
