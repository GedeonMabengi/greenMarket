...
export default function Create({ auth, categories }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Nouveau produit</h2>}
        >
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit} className="space-y-6" encType="multipart/form-data">
                            ...
                            <p className="text-xs text-gray-500">
                                Laissez vide pour utiliser votre position enregistrée. Vous pouvez aussi cliquer pour géolocaliser automatiquement.
                            </p>
